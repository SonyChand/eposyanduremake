						...
						<table class="table" id="table_id">
							...
							<tbody>
								...
								foreach ($dataKMS as $value) : ?>
									<?php
									$anak = $this->db->get_where('dataanak', ['nik' => $value['nik_anak']])->row();
									...
									<tr>
										...
										<td class>
                                            ...
                                            <?php } ?> -->
											<a href="<?php echo site_url('Petugas/HapusDataKMS/' . $value['id_pa']); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?= $anak->nama; ?> ?');" class="badge badge-danger" data-popup="tooltip" data-placement="top" title="Hapus Data">Delete</a>
										</td>
									</tr>
									<?php $i++; ?>
								<?php endforeach; ?>
